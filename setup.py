...
# Filter function to check for regular files.
def is_file(path):
    return os.path.isfile(path)

# Only include files (ignore directories) in the urdf folder.
urdf_files = [f for f in glob('urdf/*') if is_file(f)]
...
# Add all files in the 'meshes' folder recursively.
data_files.extend(collect_files_with_paths('meshes', f'share/{package_name}/meshes'))
